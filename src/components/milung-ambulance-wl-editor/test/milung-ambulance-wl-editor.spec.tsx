...
import { MilungAmbulanceWlEditor } from '../milung-ambulance-wl-editor';
...
describe('milung-ambulance-wl-editor', () => {
  ...
  it('buttons shall be of different type', async () => {
    ...
    const page = await newSpecPage({
      components: [MilungAmbulanceWlEditor],
      html: `<milung-ambulance-wl-editor entry-id="test-entry" ambulance-id="test-ambulance" api-base="http://sample.test/api"></milung-ambulance-wl-editor>`,
    });
